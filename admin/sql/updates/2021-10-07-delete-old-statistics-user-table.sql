...
ALTER TABLE statistics.user_new RENAME CONSTRAINT stats_user_new_pkey TO stats_user_pkey;
ALTER TABLE statistics.user_new RENAME CONSTRAINT user_stats_new_user_id_foreign_key TO user_stats_user_id_foreign_key;

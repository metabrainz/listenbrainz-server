...
def main():
    ...
    create_messages(RECORDING_RECORDING_TAG_DATAFRAME, MLHD_RECORDING_POPULARITY_DATAFRAME, "recording")
    create_messages(RECORDING_ARTIST_TAG_DATAFRAME, MLHD_RECORDING_POPULARITY_DATAFRAME, "artist")
    create_messages(RECORDING_RELEASE_GROUP_TAG_DATAFRAME, MLHD_RECORDING_POPULARITY_DATAFRAME, "release-group")

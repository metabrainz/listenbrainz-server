...
RECOMMENDATION_RECORDING_RECORDINGS_DATAFRAME = RECOMMENDATION_RECORDING_DATAFRAME_DIR + '/' + 'recordings_df.parquet'
# Absolute path to processed data/listens ready to be trained for `recording` recommendations.
PLAYCOUNTS_DATAFRAME_PATH = RECOMMENDATION_RECORDING_DATAFRAME_DIR + '/' + 'playcounts_df.parquet'

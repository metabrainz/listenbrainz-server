...
class UtilsTestCase(SparkTestCase):
    ...
    def test_get_artists(self):
        ...
        self.assertDictEqual(user.utils.get_artists(df), dictionary)
        self.assertEqual(user.utils.get_artists(df)['user1'][0]['listen_count'], 2)
    ...
    def test_get_releases(self):
        ...
        self.assertDictEqual(user.utils.get_releases(df), dictionary)
        self.assertEqual(user.utils.get_releases(df)['user1'][0]['listen_count'], 2)

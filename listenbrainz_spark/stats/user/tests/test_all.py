...
@patch('listenbrainz_spark.stats.user.artist.get_artists_last_week')
@patch('listenbrainz_spark.stats.user.artist.get_artists_last_month')
...
class UserStatsAllTestCase(SparkTestCase):
    def test_calculate(self, mock_get_artists_all_time, mock_get_artists_last_year,
                       mock_get_artists_last_month, mock_get_artists_last_week):
        calculate()

        mock_get_artists_last_week.assert_called_once()
        mock_get_artists_last_month.assert_called_once()

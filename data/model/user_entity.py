...
from data.model.user_artist_trend import ArtistEvolutionRecord
...
EntityRecord = Union[RecordingRecord, ReleaseGroupRecord, ReleaseRecord, ArtistRecord, ArtistEvolutionRecord]

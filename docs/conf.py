# -*- coding: utf-8 -*-
#
# ListenBrainz documentation build configuration file, created by
...
html_short_title = "ListenBrainz docs"

# The name of an image file (relative to this directory) to place at the top
# of the sidebar.
html_logo = "../listenbrainz/webserver/static/img/listenbrainz-logo.svg"
...
htmlhelp_basename = 'ListenBrainzdoc'
...
latex_documents = [
  (master_doc, 'ListenBrainz.tex', u'ListenBrainz Documentation',
...
man_pages = [
    (master_doc, 'listenbrainz', u'ListenBrainz Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ListenBrainz', u'ListenBrainz Documentation',
   author, 'ListenBrainz', 'One line description of project.',
   'Miscellaneous'),
]

...
class PinnedRecAPITestCase(IntegrationTestCase):
    ...
    def setUp(self):
        ...
        self.user = db_user.get_or_create(self.conn, 16001, "test_user_1")
        self.followed_user_1 = db_user.get_or_create(self.conn, 16002, "followed_user_1")
        self.followed_user_2 = db_user.get_or_create(self.conn, 16003, "followed_user_2")

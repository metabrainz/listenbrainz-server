...
class APITestCase(ListenAPIIntegrationTestCase):
    ...
    def setUp(self):
        ...
        self.user = db_user.get_or_create(self.conn, 10001, 'test_api_user')
        db_user.agree_to_gdpr(self.conn, self.user['musicbrainz_id'])
        
        self.followed_user = db_user.get_or_create(self.conn, 10002, 'test_api_followed_user')
    ...
    def test_similar_users(self):
        ...
        self.user2 = db_user.get_or_create(self.conn, 10003, 'test_api_all_muppets_all_of_them')
    ...
    def test_following_returns_the_people_who_follow_the_user(self):
        ...
        self.assert200(r)
        self.assertListEqual([self.followed_user['musicbrainz_id']], r.json['following'])

...
def create_import_task():
    ...
    allowed_services = ["spotify", "listenbrainz", "librefm", "maloja", "panoscrobbler", "audioscrobbler", "spinitron", "tidal"]
    ...
    if service in {"spotify", "listenbrainz"} and extension != ".zip":
    ...
    if service == "spinitron" and extension != ".csv":
        raise APIBadRequest("Only csv files are allowed for this service!")
    if service == "tidal" and extension != ".csv":
        raise APIBadRequest("Only csv files are allowed for this service!")

...
@social_api_bp.route("/user/<user_name>/followers", methods=["GET"])
@crossdomain
@ratelimit()
...
@social_api_bp.route("/user/<user_name>/following", methods=["GET"])
@crossdomain
@ratelimit()
...
@social_api_bp.route("/user/<user_name>/follow", methods=["POST"])
@crossdomain
@ratelimit()
...
@social_api_bp.route("/user/<user_name>/unfollow", methods=["POST"])
@crossdomain
@ratelimit()

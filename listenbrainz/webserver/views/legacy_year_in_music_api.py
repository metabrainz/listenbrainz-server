...
def legacy_cover_art_yim_stats(user_name, stats, year, yim24):
    ...
    if year == 2022:
        return render_template(
            ...
            bg_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-bg.png", external=True),
            magnify_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-magnify.png", external=True),
        )
...
def _cover_art_yim_albums_2022(user_name, stats):
    ...
    return render_template(
        ...
        bg_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-bg.png", external=True),
        flames_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-flames.png", external=True),
    )
...
def legacy_cover_art_yim_tracks(user_name, stats, year, yim24):
    ...
    if year == 2022:
        return render_template(
            ...
            bg_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-bg.png", external=True),
            stereo_image_url=get_static_url("img/legacy-year-in-music/year-in-music-22/yim-2022-shareable-stereo.png", external=True),
        )
...
def cover_art_yim_legacy(user, image: str, year: int = 2024, branding: bool = True):
    ...
    if year == 2024:
        yim24 = {
            ...
            "image_folder": get_static_url(f"img/legacy-year-in-music/year-in-music-24/{season}", external=True),
        }

...
MONITORED_ENTITY_LISTENER_STATS = ("artists_listeners", "release_groups_listeners")
...
def get_monitored_stats_types():
    """Return stats generated by cron_request_all_stats and monitored by service-status."""
    stats_types = []
    for stats_range in ALLOWED_STATISTICS_RANGE:
        ...
        stats_types.extend(f"{stat}_{stats_range}" for stat in MONITORED_ENTITY_LISTENER_STATS)
    return tuple(stats_types)

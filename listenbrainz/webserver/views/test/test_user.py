...
class UserViewsTestCase(IntegrationTestCase):
    ...
    def _create_test_data(self, user_name):
        ...
        self.logstore.insert(ts_conn, self.test_data)
    ...
    def test_ts_filters(self, timescale):
        ...
        user = _get_user('iliekcomputers').to_dict()
        ...
        req_call = mock.call(mock.ANY, user, limit=25, from_ts=None)
        ...
        req_call = mock.call(mock.ANY, user, limit=25, to_ts=1520946000)
        timescale.assert_has_calls([req_call])
        timescale.reset_mock()
        ...
        req_call = mock.call(mock.ANY, user, limit=25, from_ts=1520941000)
        timescale.assert_has_calls([req_call])
        timescale.reset_mock()
    ...
    def test_report_abuse(self):
        ...
        already_reported_user = db_user.is_user_reported(self.conn, self.user.id, self.user.id)
        self.assertFalse(already_reported_user)

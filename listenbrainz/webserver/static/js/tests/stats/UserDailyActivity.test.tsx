...
import * as userDailyActivityResponse from "../../src/__mocks__/userDailyActivity.json";
import * as userDailyActivityProcessedData from "../../src/__mocks__/userDailyActivityProcessData.json";

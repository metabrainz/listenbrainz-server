  ...
  render() {
    return (
      <div id="music-player" aria-label="Playback control">
        ...
        <div
          className={`info ${
            !this.state.autoHideControls ||
            !this.props.children ||
            this.props.playerPaused
              ? "showControls"
              : ""
          }`}
        >
          <div className="currently-playing">
            ...
            <div className="progress">
              <div
                ...
                style={{
                  width: `${
                    (this.props.progress_ms * 100) / this.props.duration_ms
                  }%`,
                }}
              />
            </div>
          ...
          <div className="controls">
            <div
              ...
              title={`${
                this.state.autoHideControls ? "Always show" : "Autohide"
              } controls`}
              onClick={() =>
                this.setState((state) => ({
            ...
            >
              <FontAwesomeIcon
                icon={this.state.autoHideControls ? faEyeSlash : faEye}
              />
            </div>
            <div
            ...
            <div
              ...
              title={`${this.props.playerPaused ? "Play" : "Pause"}`}
            >
              <FontAwesomeIcon
                icon={this.props.playerPaused ? faPlayCircle : faPauseCircle}
                size="2x"
              />
            </div>
            <div
            ...
            {this.props.direction !== "hidden" && (
              <div
                ...
                title={`Play ${this.props.direction === "up" ? "down" : "up"}`}
              >
                <FontAwesomeIcon
                  icon={

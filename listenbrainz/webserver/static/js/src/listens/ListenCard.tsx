...
import { getArtistLink, getTrackLink, searchForSpotifyTrack } from "../utils";
...
> {
  ...
  fetchCoverArt = async () => {
    ...
    this.APIService.getCoverArt(releaseMBID, recordingMSID).then((imageUrl) => {
      const coverArtUrl = imageUrl !== "" ? "imageUrl" : DEFAULT_COVER_ART_URL;
  ...
  render() {
    ...
    const { feedback, coverArtUrl } = this.state;
          ...
          <div className="col-xs-2 text-center">
            {mode === "follow" || mode === "recent" ? (
              ...
              <div>
                ...
                <FontAwesomeIcon icon={faHeartBroken as IconProp} />
              </div>
            )}
          </div>
        </MediaQuery>

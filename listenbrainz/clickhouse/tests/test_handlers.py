...
from listenbrainz.clickhouse.handlers import handle_user_entity_stats
...
class ClickHouseHandlerTestCase(unittest.TestCase):
    ...
    def test_handle_user_entity_stats_resolves_database_prefix(self, mock_list_databases, mock_insert):
        mock_list_databases.return_value = ["artists_all_time_20240101"]
        ...
        handle_user_entity_stats({
            ...
            "from_ts": 1,
            "to_ts": 2,
            "database_prefix": "artists_all_time",
            "data": [{
                "user_id": 42,
                "count": 1,
                "data": [{
    ...
    def test_handle_user_entity_stats_drops_invalid_entries(self, mock_insert):
        handle_user_entity_stats({
            ...
            "from_ts": 1,
            "to_ts": 2,
            "database": "artists_all_time_20240101",
            "data": [{
                "user_id": 42,
                "count": 2,
                "data": [

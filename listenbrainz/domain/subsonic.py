...
SUBSONIC_PROXY_METHODS = {"search3", "stream", "getCoverArt"}
...
class SubsonicService:
    ...
    def generate_token(password: str) -> tuple[str, str]:
        """Generate fresh Subsonic token auth parameters."""
    ...
    def authenticate(self, host_url: str, username: str, password: str) -> str:
        """Test provided credentials with Subsonic API and return encrypted password if valid."""
        try:

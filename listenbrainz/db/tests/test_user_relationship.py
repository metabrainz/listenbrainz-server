...
class UserRelationshipTestCase(DatabaseTestCase):
    def setUp(self):
        ...
        self.main_user = db_user.get_or_create(self.conn, 1, 'iliekcomputers')
    ...
    def test_insert(self):
        ...
        self.assertTrue(db_user_relationship.is_following_user(
            self.conn,
            self.main_user['id'],
    ...
    def test_is_following_user(self):
        self.assertFalse(db_user_relationship.is_following_user(
            self.conn,
            self.main_user['id'],
            self.followed_user_1['id']
        ))
    ...
    def test_delete(self):
        ...
        db_user_relationship.delete(self.conn, self.main_user['id'], self.followed_user_1['id'], 'follow')
        self.assertFalse(db_user_relationship.is_following_user(
            self.conn,
            self.main_user['id'],
            self.followed_user_1['id']
    ...
    def test_get_followers_of_user_returns_correct_data(self):
        ...
        followers = db_user_relationship.get_followers_of_user(self.conn, self.followed_user_1['id'])
        self.assertListEqual(followers, [])

        # add two relationships
        db_user_relationship.insert(self.conn, self.main_user['id'], self.followed_user_1['id'], 'follow')
        self.following_user_1 = db_user.get_or_create(self.conn, 3, 'following_user_1')
        db_user_relationship.insert(self.conn, self.following_user_1['id'], self.followed_user_1['id'], 'follow')
    ...
    def test_get_following_for_user_returns_correct_data(self):
        ...
        # no relationships yet, should return an empty list
        following = db_user_relationship.get_following_for_user(self.conn, self.main_user['id'])

...
class SimilarUserTestCase(DatabaseTestCase):
    ...
    def test_fetch_top_similar_users(self):
        user_id_1 = db_user.create(self.conn, 1, "tom")
        user_id_2 = db_user.create(self.conn, 2, "jerry")
        ...
        """), user_id_1=user_id_1, similar_users_1=json.dumps(similar_users_1),
                          user_id_2=user_id_2, similar_users_2=json.dumps(similar_users_2))

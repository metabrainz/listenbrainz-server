...
class TestAPICompatTokenClass(DatabaseTestCase):
    ...
    def test_generate(self):
        token = Token.generate(self.conn, str(uuid.uuid4()))
        self.assertIsInstance(token, Token)

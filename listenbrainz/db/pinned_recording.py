...
def pin(connection, pinned_recording: WritablePinnedRecording):
...
def unpin(connection, user_id: int):
...
def delete(connection, row_id: int, user_id: int):
...
def get_current_pin_for_user(connection, user_id: int) -> PinnedRecording:
...
def get_pin_history_for_user(connection, user_id: int, count: int, offset: int) -> List[PinnedRecording]:
...
def get_pins_for_user_following(connection, user_id: int, count: int, offset: int) -> List[PinnedRecording]:
...
def get_pins_for_feed(connection, user_ids: List[int], min_ts: int, max_ts: int, count: int) -> List[PinnedRecording]:
...
def get_pin_by_id(connection, row_id: int) -> PinnedRecording:
...
def get_pin_count_for_user(connection, user_id: int) -> int:

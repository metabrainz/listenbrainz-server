...
class Session(object):
    ...
    def __init__(self, connection, id, user_id, sid, api_key, timestamp):
        self.id = id
        self.sid = sid
        self.api_key = api_key
        self.timestamp = timestamp
        self.user_id = user_id
        self.user = User.load_by_id(connection, user_id)

    @staticmethod
    def load(connection, session_key):
    ...
    @staticmethod
    def generate(connection, user_id, sid, api_key):
        result = connection.execute(text("""
    ...
    @staticmethod
    def create_by_user_id(connection, user_id):
        ...
        return Session.generate(connection, user_id, sid, api_key)

...
def update_import_status(connection, user_id: int, service: ExternalServiceType, error_message: str = None):
...
def update_latest_listened_at(connection, user_id: int, service: ExternalServiceType, timestamp: Union[int, float]):
...
def get_latest_listened_at(connection, user_id: int, service: ExternalServiceType) -> Optional[datetime.datetime]:

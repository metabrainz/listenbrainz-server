...
class Token(object):
    ...
    def __init__(self, db_conn: Connection, id, userid, token, api_key, ts):
        self.id = id
        self.token = token
    ...
    @staticmethod
    def load(db_conn: Connection, token, api_key=None):
    ...
    @staticmethod
    def generate(db_conn: Connection, api_key):
    ...
    def approve(self, db_conn: Connection, user):
    ...
    def consume(self, db_conn: Connection):

...
```
docker run -p 127.0.0.1:8108:8108 -d -v listenbrainz-typesense:/data --name=listenbrainz-typesense --network=musicbrainz-docker_default typesense/typesense:27.1 --data-dir /data --api-key=<the api key>
```

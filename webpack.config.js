...
module.exports = function (env, argv) {
  ...
  return {
    entry: {
      ...
      recentListens: [
        path.resolve(jsDir, "src/stats/RecentListens.tsx"),
      ...
      userPageHeading: path.resolve(jsDir, "src/stats/UserPageHeading.tsx"),
      userFeedback: path.resolve(jsDir, "src/stats/UserFeedback.tsx"),
